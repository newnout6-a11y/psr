...
KWORK_ACCOUNTS_FILE = RUNTIME_DIR / "kwork_accounts.json"
KWORK_ACCOUNTS_DB_FILE = RUNTIME_DIR / "kwork_accounts.db"
KWORK_ACCOUNTS_KEY_FILE = RUNTIME_DIR / "kwork_accounts.key"
