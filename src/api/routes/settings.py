...
_ENV_KEYS = [
    # LLM
    "OPENAI_API_KEY", "OPENAI_API_KEYS", "OPENAI_BASE_URL", "OPENAI_API_PREFIX", "OPENAI_WIRE_API",
    "OPENAI_MODEL", "OPENAI_REASONING_EFFORT", "OPENAI_DISABLE_RESPONSE_STORAGE",
    "DEEPSEEK_API_KEY", "DEEPSEEK_BASE_URL", "DEEPSEEK_API_PREFIX", "DEEPSEEK_WIRE_API",
    "DEEPSEEK_MODEL", "DEEPSEEK_REASONING_EFFORT", "DEEPSEEK_THINKING",
    "DEEPSEEK_MODEL_QUERY_GENERATION", "DEEPSEEK_MODEL_SCORING",
    "GROQ_API_KEY", "LLM_PROVIDER",
    "PARSER_LLM_PROVIDER", "PARSER_LLM_MODEL",
    "GROQ_MODEL",
    "AI_SCORE_THRESHOLD", "AI_SCORE_MODE", "AI_SCORE_BATCH_SIZE", "AI_SCORE_DEEPSEEK_BATCH_SIZE", "AI_SCORE_MAX_CANDIDATES",
    "QUERY_GENERATION_PROVIDER", "SCORING_PROVIDER",
    "PROPOSAL_WRITING_PROVIDER", "PROPOSAL_IMAGE_ENABLED", "PROPOSAL_IMAGE_MODEL",
    "PROPOSAL_IMAGE_MIN_AI_SCORE", "PROPOSAL_IMAGE_MIN_VET_SCORE", "KWORK_IMAGE_ATTACH_CONFIRMED",
    "ATTACHMENT_CONTEXT_ENABLED",
    "ATTACHMENT_MAX_FILES", "ATTACHMENT_MAX_BYTES", "ATTACHMENT_MAX_CHARS",
    # Platforms
