...
class OriginFinder:
    ...
    def request_with_origin(self, origin_ip: str, domain: str, path: str = "/", method: str = "GET", **kwargs):
        """
        ...
        return curl_requests.request(
            method=method, url=url, headers=headers, verify=False, impersonate="chrome_120", **kwargs
        )
