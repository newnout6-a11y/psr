...
function KworkTab({
  ...
  const coverImageKeys = [
    ...
    'KWORK_COVER_IMAGE_QUALITY', 'KWORK_PORTFOLIO_IMAGE_SIZE', 'KWORK_PORTFOLIO_IMAGE_QUALITY',
    'KWORK_PORTFOLIO_IMAGE_CONCURRENCY', 'KWORK_COVER_IMAGE_TIMEOUT', 'KWORK_COVER_VISION_PROVIDER',
    'KWORK_COVER_VISION_MODEL', 'KWORK_COVER_VISION_MAX_TOKENS', 'KWORK_COVER_QA_ENABLED',
    'KWORK_COVER_QA_PROVIDER',
    'KWORK_COVER_QA_MODEL', 'KWORK_COVER_QA_MIN_SCORE', 'KWORK_COVER_PROMPT_PROVIDER',
